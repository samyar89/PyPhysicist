...
_UNIT_DEFINITIONS: Dict[str, UnitSpec] = {
    ...
    "in": UnitSpec(0.0254, {"m": 1}),
    "ft": UnitSpec(0.3048, {"m": 1}),
    "yd": UnitSpec(0.9144, {"m": 1}),
    "mi": UnitSpec(1609.344, {"m": 1}),
    "au": UnitSpec(1.495978707e11, {"m": 1}),
    "ly": UnitSpec(9.460730472e15, {"m": 1}),
    "s": UnitSpec(1.0, {"s": 1}),
    ...
    "h": UnitSpec(3600.0, {"s": 1}),
    "hr": UnitSpec(3600.0, {"s": 1}),
    "hour": UnitSpec(3600.0, {"s": 1}),
    "day": UnitSpec(86400.0, {"s": 1}),
    "week": UnitSpec(604800.0, {"s": 1}),
    "kg": UnitSpec(1.0, {"kg": 1}),
    "g": UnitSpec(1.0e-3, {"kg": 1}),
    "mg": UnitSpec(1.0e-6, {"kg": 1}),
    "Mg": UnitSpec(1.0e3, {"kg": 1}),
    "t": UnitSpec(1.0e3, {"kg": 1}),
    "tonne": UnitSpec(1.0e3, {"kg": 1}),
    "lb": UnitSpec(0.45359237, {"kg": 1}),
    "oz": UnitSpec(0.028349523125, {"kg": 1}),
    "A": UnitSpec(1.0, {"A": 1}),
    "K": UnitSpec(1.0, {"K": 1}),
    "degC": UnitSpec(1.0, {"K": 1}, offset=273.15),
    "degF": UnitSpec(5.0 / 9.0, {"K": 1}, offset=459.67),
    ...
    "eV": UnitSpec(1.602176634e-19, {"kg": 1, "m": 2, "s": -2}),
    "kWh": UnitSpec(3.6e6, {"kg": 1, "m": 2, "s": -2}),
    "W": UnitSpec(1.0, {"kg": 1, "m": 2, "s": -3}),
    "Pa": UnitSpec(1.0, {"kg": 1, "m": -1, "s": -2}),
    "bar": UnitSpec(1.0e5, {"kg": 1, "m": -1, "s": -2}),
    "atm": UnitSpec(101325.0, {"kg": 1, "m": -1, "s": -2}),
    "psi": UnitSpec(6894.757293168, {"kg": 1, "m": -1, "s": -2}),
    "C": UnitSpec(1.0, {"A": 1, "s": 1}),
    "V": UnitSpec(1.0, {"kg": 1, "m": 2, "s": -3, "A": -1}),
    "ohm": UnitSpec(1.0, {"kg": 1, "m": 2, "s": -3, "A": -2}),
    "F": UnitSpec(1.0, {"kg": -1, "m": -2, "s": 4, "A": 2}),
    "L": UnitSpec(1.0e-3, {"m": 3}),
    "l": UnitSpec(1.0e-3, {"m": 3}),
    "liter": UnitSpec(1.0e-3, {"m": 3}),
    "litre": UnitSpec(1.0e-3, {"m": 3}),
    "mL": UnitSpec(1.0e-6, {"m": 3}),
}
